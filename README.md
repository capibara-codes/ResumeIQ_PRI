...
ResumeIQ is an intelligent web application built with Streamlit, spaCy, and Gemini to help candidates improve their resumes. It parses resumes (PDF/DOCX), extracts key entities and skills, calculates a match score against a target job description, and provides actionable AI-generated feedback. Deployed on Streamlit.

link : https://resumeiqpri-o4uxriwtl9afrco5dpt33c.streamlit.app/

## Features

- **Document Parsing:** Supports both PDF and DOCX file uploads and you can also drag and drop.
...
- **AI Feedback:** Integrates with Gemini 2.5 flash to analyze the resume and suggest improvements, pointing out strengths and weaknesses.
